...
export function registerRenderRoutes(fastify: FastifyInstance) {
   ...
   */
  fastify.post('/render/music', { preHandler: requireAuth }, async (request, reply) => {
   ...
   */
  fastify.post('/render/vocals', { preHandler: requireAuth }, async (request, reply) => {
   ...
   */
  fastify.post('/render/preview', { preHandler: requireAuth }, async (request, reply) => {
